...
def generate_launch_description():
    ...
    bringup_dir = get_package_share_directory('unitree_g1_ros2') # package name
    ...
    declare_urdf_cmd = DeclareLaunchArgument(
        'urdf_file',
        default_value=os.path.join(bringup_dir, 'urdf', 'g1_29dof_with_hand_rev_1_0.urdf'),  # urdf file name
        description='Whether to start RVIZ')
